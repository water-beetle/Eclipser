...
void AEclipserCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AEclipserCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AEclipserCharacter::Look);
...
void AEclipserCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AEclipserCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AEclipserCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AEclipserCharacter::DoJumpEnd()
{
