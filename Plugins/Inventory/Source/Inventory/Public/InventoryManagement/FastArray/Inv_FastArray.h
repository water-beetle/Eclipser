...
struct FInv_InventoryFastArray : public FFastArraySerializer
{
	...
	void PreReplicatedRemove(const TArrayView<int32> RemoveIndicies, int32 FinalSize);
	void PostReplicatedAdd(const TArrayView<int32> AddIndicies, int32 FinalSize);
	...
	UInv_InventoryItem* AddEntry(UInv_ItemComponent* ItemComponent) const;
